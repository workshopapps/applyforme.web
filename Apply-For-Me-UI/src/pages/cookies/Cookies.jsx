        ...
        <div>
            ...
            <div className="container">
                ...
                <div>
                    ...
                    <p className="paragraphs">
                        You have the ability to control the use of certain cookies and similar technologies. <br></br>
                        <br></br>
                        Opt-in and Opt-out on BrowsersYou may block cookies by activating the setting on your browser that allows you to refuse the setting of all or some cookies. However, if you use your browser settings to block all cookies (including essential cookies) you may not be able to access all or parts of our Sites.<br></br>
                        <br></br>
                        Opt-out of Third-Party NetworksFor more information about third-party ad networks and services that use these technologies, and the ability to-opt out from tracking by participating vendors, you can visit <span>www.aboutads.info</span> or, if you are in the EU (<span>http://youronlinechoices.eu/</span>). You also may visit the NAI’s site for additional options on how to opt out of interest-based advertising (at <span>https://optout.networkadvertising.org</span>).<br></br>
                        <br></br>
                        Google Analytics Opt-outFor Google Analytics Advertising Features, you can opt-out through Google Ads Settings, Ad Settings for mobile apps, or any other available means (for example, the NAI's consumer opt-out listed above). You may find out more and opt-out here: <span>www.google.com/policies/privacy/partners/</span> and Opt-out here <span>https://adssettings.google.com.</span><br></br>
                        <br></br>
                ...
                <div>
                    ...
                    <p className="paragraphs">
                        If you have questions about our use of cookies and similar technologies, please see the “<span> <a href="Contact">Contact Us</a></span>” section of our <span> <a href="Privacy.jsx">Privacy Policy</a></span>.
                    </p>
                </div>
            </div>
