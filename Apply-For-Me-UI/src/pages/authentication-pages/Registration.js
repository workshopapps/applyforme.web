  ...
  return (
    <div className='Registration'>
        <div className='reg'>
            <Navbar/>
            <div className='rbdy'>
                <Text className="reg" child="Please fill in this necessary information"/>
                <Text2 child="Complete your registration"/>
                <div className='form'>
                <div className='select-wrapper'>
                    <select  name="cars register-select" id="cars">
            ...
            <Link to='/wel2' className='lg'><Button child="Continue"/></Link>
        </div>
    </div>
  )
}
