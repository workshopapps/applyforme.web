        ...
        <div className="form_wrapper_bg">
            ...
            <div>
                <form className='pay_form_wrapper'>
                    ...
                    <p className='confirm_text'>Please Confirm your payment information to continue</p>
                    <div className='inputDiv_wrapper'>
                        <label htmlFor="name" className='form_label'>
                            Name
                        </label>
                        <input type="text" name="name" className='pay_input' defaultValue={decoded?.fullName}/>
                    </div>
                    <div className='inputDiv_wrapper'>
                        <label htmlFor="email" className='form_label'>
                            Email
                        </label>
                        <input type="email" name="email" className='pay_input' defaultValue={decoded?.emailAddress}/>
                    </div>
                    <div className='inputDiv_wrapper'>
                        <label htmlFor="amount" className='form_label'>
                            Amount
                        </label>
                        <input type="text" name="amount" className='pay_input' defaultValue={`$ ${price}`}/>
                    </div>
