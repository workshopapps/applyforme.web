...
job_seniority, desired_job_title, industry, years_of_experience)


INSERT INTO job_submission (job_title, job_link, job_location, job_company, job_location_type, professional_id, applier_id);
